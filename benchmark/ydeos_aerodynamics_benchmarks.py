...
from ydeos_aerodynamics.apparent import apparent_wind_angle, apparent_wind_speed, apparent_wind
...
from ydeos_aerodynamics.distribution import weibull_pdf, weibull_cdf, weibull_mean, weibull_random_samples
...
to_profile = (
    ...
    #
    (aero_force, [10., 45., 2., 0., 0., "main", 0.3, (1., 2., 3.), "jib", 0.2, (1., 2., 3.), 1.6], {}),)
