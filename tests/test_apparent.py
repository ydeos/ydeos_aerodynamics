...
def test_awa_unrealistic_heel_angle():
    r"""Dealing with a heel angle beyond 90 degrees"""
    with pytest.raises(ValueError):
        apparent_wind_angle(true_wind_speed=1.,
                            true_wind_angle=45.,
                            boatspeed=0.,
                            heel_angle=90.1,
...
def test_aws_unrealistic_heel_angle():
    r"""Dealing with a heel angle beyond 90 degrees"""
    with pytest.raises(ValueError):
        apparent_wind_speed(true_wind_speed=1.,
                            true_wind_angle=45.,
                            boatspeed=0.,
                            heel_angle=90.1,
                            check_heel_angle=True)
...
def test_awa_zero_boatspeed_twa():
    ...
    awa_zero_boatspeed_1 = apparent_wind_angle(true_wind_speed=10.,
                                               true_wind_angle=45.,
                                               boatspeed=0.)
    assert awa_zero_boatspeed_1 == 45.

    awa_zero_boatspeed_2 = apparent_wind_angle(true_wind_speed=10.,
                                               true_wind_angle=-165.,
                                               boatspeed=0.)
    ...
    awa_zero_boatspeed_3 = apparent_wind_angle(true_wind_speed=10.,
                                               true_wind_angle=90.,
                                               boatspeed=0.)
...
def test_awa_known_values():
    r"""Known values"""
    awa_reaching_same_speed_as_tws = apparent_wind_angle(true_wind_speed=10.,
                                                         true_wind_angle=90.,
                                                         boatspeed=10.)
    assert awa_reaching_same_speed_as_tws == 45.

    awa_almost_downwind = apparent_wind_angle(true_wind_speed=10.,
                                              true_wind_angle=170.,
                                              boatspeed=1.)
...
def test_awa_known_values_going_backwards():
    ...
    awa_head_to_wind_no_apparent = apparent_wind_angle(true_wind_speed=10.,
                                                       true_wind_angle=0.,
                                                       boatspeed=-10.)
...
def test_awa_opposite_heel_angles():
    ...
    awa_heeled_40_degrees = apparent_wind_angle(true_wind_speed=10.,
                                                true_wind_angle=120.,
                                                boatspeed=3.,
                                                heel_angle=40.)
    awa_counterheeled_40_degrees = apparent_wind_angle(true_wind_speed=10.,
                                                       true_wind_angle=120.,
                                                       boatspeed=3.,
                                                       heel_angle=-40.)
...
def test_awa_90_degrees_heel():
    r""" Boat at 90° heel"""
    awa_heeled_90_degrees_1 = apparent_wind_angle(true_wind_speed=10.,
                                                  true_wind_angle=75.,
                                                  boatspeed=3.,
                                                  heel_angle=90.)
    ...
    awa_heeled_90_degrees_2 = apparent_wind_angle(true_wind_speed=10.,
                                                  true_wind_angle=90.,
                                                  boatspeed=3.,
                                                  heel_angle=90.)
    expected_value, atol = 0., 1e-6
...
def test_aws_known_values():
    ...
    aws_head_to_wind = apparent_wind_speed(true_wind_speed=10.,
                                           true_wind_angle=0.,
                                           boatspeed=10.)
    assert aws_head_to_wind == 20.

    # fully downwind
    aws_downwind = apparent_wind_speed(true_wind_speed=10.,
                                       true_wind_angle=180.,
                                       boatspeed=3.)
    assert aws_downwind == 7.

    # 90° reach at the same speed as true_wind_speed
    aws_reaching_same_boatspeed_as_tws = \
        apparent_wind_speed(true_wind_speed=10.,
                            true_wind_angle=90.,
                            boatspeed=10.)
...
def test_aws_known_values_going_backwards():
    r"""Known values going backwards"""
    aws_going_backwards_head_to_wind = apparent_wind_speed(true_wind_speed=10.,
                                                           true_wind_angle=0.,
                                                           boatspeed=-10.)
...
def test_aws_opposite_twa():
    r"""Opposite twas"""
    aws_beating_on_starboard = apparent_wind_speed(true_wind_speed=10.,
                                                   true_wind_angle=45.,
                                                   boatspeed=3.)
    aws_beating_on_port = apparent_wind_speed(true_wind_speed=10.,
                                              true_wind_angle=-45.,
                                              boatspeed=3.)
...
def test_apparent_wind():
    r"""Test the happy path of apparent_wind()"""
    apparent = apparent_wind(true_wind_speed=10.,
                             true_wind_angle=90.,
                             boatspeed=10.)
    assert apparent["speed"] == 10 * math.sqrt(2)
    assert apparent["angle"] == 45.
